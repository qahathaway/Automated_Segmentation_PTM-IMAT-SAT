...
gt::gtsave(as_gt(Summary), file = 'C:/Users/hamza/OneDrive/Desktop/Research/Post-Doc Stuff/Three Projects MESA Cleanup/MESA Incident CHF/PostMeetingResults/12MayDescriptiveTable.rtf')
