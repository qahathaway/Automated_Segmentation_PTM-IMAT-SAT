...
step3$pmi5c = ((step3$EngelkeRightPectoralisMuscleArea + step3$EngelkeLeftPectoralisMuscleArea) )

step3$iai5c1 = ((step3$RightEngelkeIMF + step3$LeftEngelkeIMF))

step3$sai5c = ((step3$Subcutaneous.Adipose.Tissue) )
...
step3$EML5c1 = ((step3$Extramyocellular.Lipid...Right + step3$Extramyocellular.Lipid...Left) )
step3$PAT5c1 = ((step3$Perimuscular.Adipose.Tissue..Right + step3$Perimuscular.Adipose.Tissue..Left) )
...
DATA$htn5c = as.factor(DATA$htn5c) #Factorized Hypertension Medication Use 
...
##Summary Table
Summary = DATA %>% select(age5c, gender1, pkyrs5c, htn5c, agatpm5c, iai5c1, EML5c1, PAT5c1, pmi5c, sai5c, race1c, pamvcm5c, olvef5t) %>% 
  tbl_summary(
    label = list(
      age5c ~ 'Age',
      gender1 ~ 'Sex',
      htn5c ~ 'Hypertension (JNC IV Criteria)',
      pkyrs5c ~ 'Pack Years of Smoking',
...
PModelMuscleIndexLVH = coxph(Surv(followuptime, chf)~ age5c   + gender1  + bmi5c+ income5+ race1c + pkyrs5c  +curalc5 + htn5c  + hba1c5 + creatin5t + pamvcm5c +htnmed5c + lipid5c + diabins5 + chlcat5c +  pmi5c, data = DATA)
PModelFatIndex1LVH  = coxph(Surv(followuptime, chf)~ age5c   + gender1  + bmi5c+ income5+ race1c+ pkyrs5c+curalc5+ htn5c  + hba1c5 + creatin5t +pamvcm5c +htnmed5c + lipid5c + diabins5 + chlcat5c +   iai5c1, data = DATA)
PModelEMLLVH  = coxph(Surv(followuptime, chf)~ age5c   + gender1  + bmi5c+ income5+ race1c+ pkyrs5c +curalc5 + htn5c  + hba1c5 + creatin5t +pamvcm5c  +htnmed5c + lipid5c + diabins5 + chlcat5c+   EML5c1, data = DATA)
PModelPATLVH  = coxph(Surv(followuptime, chf)~ age5c   + gender1  + bmi5c+ income5+ race1c+ pkyrs5c +curalc5 + htn5c   + hba1c5 + creatin5t+pamvcm5c  +htnmed5c + lipid5c + diabins5 + chlcat5c+   PAT5c1, data = DATA)
PModelSFATLVH  = coxph(Surv(followuptime, chf)~ age5c   + gender1 + bmi5c+ income5 + race1c+ pkyrs5c +curalc5 + htn5c  + hba1c5 + creatin5t +pamvcm5c +htnmed5c + lipid5c + diabins5 + chlcat5c +   sai5c, data = DATA)
...
ModelCACMuscleIndexLVH = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1 + bmi5c+ income5 + pkyrs5c+curalc5   + htn5c  + hba1c5 + creatin5t+ CACSCORE +pamvcm5c  +htnmed5c + lipid5c + diabins5 + chlcat5c+   pmi5c, data = DATA)
ModelCACFatIndex1LVH  = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1  + bmi5c+ income5+ pkyrs5c+curalc5+ htn5c  + hba1c5 + creatin5t+ CACSCORE +pamvcm5c  +htnmed5c + lipid5c + diabins5 + chlcat5c+   iai5c1, data = DATA)
ModelCACEMLLVH  = coxph(Surv(followuptime, chf)~ age5c   + race1c+ gender1  + bmi5c+ income5+ pkyrs5c +curalc5 + htn5c  + hba1c5 + creatin5t+ CACSCORE +pamvcm5c +htnmed5c + lipid5c + diabins5 + chlcat5c +   EML5c1, data = DATA)
ModelCACPATLVH  = coxph(Surv(followuptime, chf)~ age5c   + race1c+ gender1  + bmi5c+ income5+ pkyrs5c +curalc5 + htn5c  + hba1c5 + creatin5t+ CACSCORE +pamvcm5c +htnmed5c + lipid5c + diabins5 + chlcat5c+   PAT5c1, data = DATA)
ModelCACSFATLVH  = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1 + bmi5c+ income5 + pkyrs5c+curalc5  + htn5c + hba1c5 + creatin5t + CACSCORE +pamvcm5c  +htnmed5c + lipid5c + diabins5 + chlcat5c+   sai5c, data = DATA)
...
ModelMuscleIndexLVH = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1  + income5+ pkyrs5c  +curalc5 + htn5c + CACSCORE + pamvcm5c+ + hba1c5 +  creatin5t +htnmed5c + lipid5c + diabins5 + chlcat5c +olvef5t+  LVMASSPRED +pmi5c, data = DATA)
ModelFatIndex1LVH  = coxph(Surv(followuptime, chf)~ age5c   + race1c+ gender1  + income5+ pkyrs5c +curalc5  + htn5c + CACSCORE +pamvcm5c + hba1c5 + creatin5t +htnmed5c + lipid5c + diabins5 + chlcat5c+olvef5t+   LVMASSPRED +iai5c1, data = DATA)
ModelEMLLVH  = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1  + income5+ pkyrs5c  +curalc5 + htn5c + CACSCORE +pamvcm5c + hba1c5 + creatin5t +htnmed5c + lipid5c + diabins5 + chlcat5c+olvef5t+   LVMASSPRED+ EML5c1, data = DATA)
ModelPATLVH  = coxph(Surv(followuptime, chf)~ age5c   + race1c+ gender1  + income5+ pkyrs5c  +curalc5 + htn5c + CACSCORE +pamvcm5c + hba1c5 + creatin5t +htnmed5c + lipid5c + diabins5 + chlcat5c+olvef5t+   LVMASSPRED+ PAT5c1, data = DATA)
ModelSFATLVH  = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1  + income5+ pkyrs5c +curalc5  + htn5c + CACSCORE +pamvcm5c+ hba1c5 + creatin5t  +htnmed5c + lipid5c + diabins5 + chlcat5c+olvef5t+   LVMASSPRED+ sai5c, data = DATA)
...
NULLMODEL = coxph(Surv(followuptime, chf)~ age5c  + race1c + gender1+ bmi5c + income5 + pkyrs5c  +curalc5 + htn5c + CACSCORE +pamvcm5c+ hba1c5 + creatin5t  +htnmed5c + lipid5c + diabins5 + chlcat5c+   LVMASSPRED, data = DATA)
...
CompareC(followuptime, chf, predict(ModelMuscleIndexLVH, type = 'risk'), predict(NULLMODEL, type = 'risk') )
CompareC(followuptime, chf, predict(ModelFatIndex1LVH, type = 'risk'), predict(NULLMODEL, type = 'risk') )
CompareC(followuptime, chf, predict(ModelEMLLVH, type = 'risk'), predict(NULLMODEL, type = 'risk') )
CompareC(followuptime, chf, predict(ModelPATLVH, type = 'risk'), predict(NULLMODEL, type = 'risk') )
CompareC(followuptime, chf, predict(ModelSFATLVH, type = 'risk'), predict(NULLMODEL, type = 'risk') )
...
ggsurvplot(
  ...
  palette =
    c("#4AA0A0", "#000000"),# custom color palettes
